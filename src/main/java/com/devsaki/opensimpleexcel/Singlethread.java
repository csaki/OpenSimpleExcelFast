...
/**
 * Created by devsaki on 02/10/17.
 */
public class Singlethread {
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        Object[][] sheet = processSheet1(new CharReader(sheet1));
        String[] words = processSharedStrings(new CharReader(sharedString));
    ...
    public static Object[][] processSheet1(CharReader br) throws IOException, ExecutionException, InterruptedException {
        ...
        for (int i = charReaders.length - 1; i >= 0; i--) {
            final int j = i;
            inParallelProcess(charReaders[j], j == 0 ? null : charReaders[j - 1], result);
        }
